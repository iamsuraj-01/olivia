...
// Reusable function to redirect to WhatsApp
...
const btnSecond = document.getElementById("bookSessionBtnSecond");

// Add event listeners to the buttons
if (btn) btn.addEventListener("click", redirectToWhatsApp);
if (btnSecond) btnSecond.addEventListener("click", redirectToWhatsApp);
